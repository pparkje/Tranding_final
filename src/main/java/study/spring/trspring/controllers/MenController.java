...
public class MenController {
	...
	@RequestMapping(value = "/pjh/jsp/men.do", method = RequestMethod.GET)
	public ModelAndView view(Model model,
		...
		try {
			...
			totalCount = goodsService.getGoodsCount(inputA);
			...
			outputA = goodsService.getGoodsList(inputA);
		...
		return new ModelAndView("pjh/jsp/men");
	}
	
	@RequestMapping(value = "/pjh/jsp/menA.do", method = RequestMethod.GET)
	public ModelAndView viewA(Model model,
		...
		PageData pageData = null;
			...
			try {
				...
				if(sessionA == 1) {
					outputA = goodsService.getGoodsListD(inputA);
				} else if ( sessionA == 2) {
					outputA = goodsService.getGoodsListE(inputA);
				} else if ( sessionA == 3) {
					outputA = goodsService.getGoodsListF(inputA);
				} else if ( sessionA == 4){
					outputA = goodsService.getGoodsListG(inputA);
				} else {
					outputA = goodsService.getGoodsList(inputA);
				}
	...
	@RequestMapping(value = "/pjh/jsp/menB.do", method = RequestMethod.GET)
	public ModelAndView viewB(Model model,
		...
		if(maxsale != 0 || minsale != 0) {
			try {
				...
				outputB = goodsService.getGoodsHalInList(inputA);
	...
	@RequestMapping(value = "/pjh/jsp/menF.do", method = RequestMethod.POST)
