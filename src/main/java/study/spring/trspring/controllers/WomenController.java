...
public class WomenController {
	...
	@RequestMapping(value = "/pjh/jsp/women.do", method = RequestMethod.GET)
	public ModelAndView view(Model model,
		...
		return new ModelAndView("pjh/jsp/women");
	}
	
	@RequestMapping(value = "/pjh/jsp/womenA.do", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/pjh/jsp/womenB.do", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/pjh/jsp/womenF.do", method = RequestMethod.POST)
