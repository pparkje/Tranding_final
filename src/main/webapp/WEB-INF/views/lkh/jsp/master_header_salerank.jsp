...
<body>
	...
	Admins keyC_K = (Admins) session.getAttribute("keyA");
    session.setAttribute("keyA", keyC_K);
%>       
    <%@ include file="../jsp/master_header.jsp" %>
    
    <div class="top_box2">
        <div class="title_and_button clearfix">
            <span class="title_text pull-left">상품판매순위</span>
            <div class="button_place pull-left">
                ...
                <a href="${pageContext.request.contextPath}/tranding/master_product_insert.do"><button class="button_property1 button_a4" type="button">상품등록</button></a>
            </div>
        </div>
    </div>
    <!-- header -->
