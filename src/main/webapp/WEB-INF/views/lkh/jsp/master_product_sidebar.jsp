...
<body>
 <%
	...
	Admins keyC_O = (Admins) session.getAttribute("keyA");
    session.setAttribute("keyA", keyC_O);
%>      
	<!-- sidebar -->
    <div class="sidebar_place pull-left">
        ...
        <div class="sidebar_text_place pull-left">
            <div class="sidebar_text_place2">
                <h3>상품</h3>
                <ul>
                    <li><a href="${pageContext.request.contextPath}/tranding/master_product_manager.do"">상품관리</a></li>
                    <li><a href="${pageContext.request.contextPath}/tranding/master_product_salerank.do">상품판매순위</a></li>
                    <li><a href="${pageContext.request.contextPath}/tranding/master_product_inventory.do">상품재고관리</a></li>
                    <li><a href="${pageContext.request.contextPath}/tranding/master_product_inventoryoption.do">상품옵션재고관리</a></li>
                    <li><a href="${pageContext.request.contextPath}/tranding/master_product_type.do">상품유형관리</a></li>
                </ul>
            </div>
        </div>
    </div>
