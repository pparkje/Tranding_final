    ...
    <div class="sidebar_place pull-left">
        ...
        <div class="sidebar_text_place pull-left">
            <div class="sidebar_text_place2">
                <h3>회원관리</h3>
                <ul>
                    <li><a href="${pageContext.request.contextPath}/pjh/members/members_list.do"">회원관리</a></li>
                    <li><a href="${pageContext.request.contextPath}/pjh/members/members_point.do">포인트(D머니)관리</a></li>
                    <li><a href="${pageContext.request.contextPath}/pjh/members/email_list.do">이메일내역관리</a></li>
                </ul>
            </div>
        </div>
    </div>
