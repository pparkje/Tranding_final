...
Goods goodsAC = (Goods) session.getAttribute("id");
session.setAttribute("id", goodsAC);
%>
<div class="login_main_A">
	<div class="login_main_left_A">
		<div class="heawon_A">회원가입</div>
		<form method="post" action="${pageContext.request.contextPath}/pjh/members/cart_add_ok.do">
	...
	<div class="login_main_right_A">
		<form method="post" action="${pageContext.request.contextPath}/pjh/jsp/cartpage_login_ok.do">
