...
Members keyG = (Members) session.getAttribute("key");
session.setAttribute("key", keyG);

Goods goodsB = (Goods) session.getAttribute("id");
session.setAttribute("id", goodsB);
%>
			...
			<div class="look_img">
				<div class="look_img1">
					<a href="${pageContext.request.contextPath}/views/tranding/img/${output.g_image_a}" data-lightbox="myphoto-1">
						<img src="${pageContext.request.contextPath}/views/tranding/img/${output.g_image_a}" alt="사진" />
					</a>
				</div>
			</div>
