...
<%@ page import="study.spring.trspring.model.Email"%>
<!doctype html>
<html>
...
Members keyK = (Members) session.getAttribute("key");
session.setAttribute("key", keyK);
	...
	<div class="pass_word_A_pass">
		<div class="pass_word_A_A">
			...
			<div class="pass_word_main_B">
				<form action="${pageContext.request.contextPath}/pjh/jsp/no_id_passChange_ok_A.do" method="post">
					<div class="pass_id_A">인증번호: </div>
