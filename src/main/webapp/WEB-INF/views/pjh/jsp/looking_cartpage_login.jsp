...
Goods goodsAA = (Goods) session.getAttribute("id");
session.setAttribute("id", goodsAA);
%>
<div class="login_main_A">
	<div class="login_main_left_A">
		<div class="heawon_A">회원가입</div>
		<form method="post" action="${pageContext.request.contextPath}/pjh/members/look_cart_add_ok.do">
	...
	<div class="login_main_right_A">
		<c:url value="/pjh/jsp/looking_cartpage_login_ok.do" var="viewUrl"></c:url>
		<form method="post" action="${viewUrl}">
