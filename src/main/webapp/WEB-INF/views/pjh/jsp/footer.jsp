		...
		<div class="footer_other">
			...
			<div class="footer_company">
				...
				<div class="footer_company_info">
					...
					<ul class="footer_sns">
						<li class="footer_insta"><a href="https://www.instagram.com/"><span
								class="sr-only">인스타그램</span><i class="fa fa-instagram"
								aria-hidden="true" style="font-size: 25px;"></i> </a></li>
						<li class="footer_facebook"><a href="https://www.facebook.com/"><span
								class="sr-only">페이스북</span><i class="fa fa-facebook-official"
								aria-hidden="true" style="font-size: 25px;"></i> </a></li>
						<li class="footer_youtube"><a href="https://www.youtube.com/"><span
								class="sr-only">유튜브</span><i class="fa fa-youtube-play"
								aria-hidden="true" style="font-size: 25px;"></i> </a></li>
						<li class="footer_blog"><a href="https://section.blog.naver.com/BlogHome.nhn?directoryNo=0&currentPage=1&groupId=0"><span class="sr-only">블로그</span><i
