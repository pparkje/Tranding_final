...
Members key_C = (Members) session.getAttribute("key");
session.setAttribute("key", key_C);
%>
<!-- 이곳에 html , css , js , jQuery 적용하면 됩니다. -->
<div class="brand_brand">
    <div class="brand_brand_top">
        <div class="brand_brand_text">
            <a href="${pageContext.request.contextPath}/pjh/jsp/brand_brand.do" class="brand_brandtext">BRAND</a>
            <ul class="brand_brandtext1">
                <li>
            ...
            <div class="brand_brandtext2">
                <select class="brand_brand2" name="clas" id="clas" onchange="goUrl(this.options[this.selectedIndex].value)">
                   <c:url value="/pjh/jsp/brand_brandA.do" var="URLA">
						 ...
						 <c:url value="/pjh/jsp/brand_brandA.do" var="URLB">
						 ...
						 <c:url value="/pjh/jsp/brand_brandA.do" var="URLC">
						 ...
						 <c:url value="/pjh/jsp/brand_brandA.do" var="URLD">
    ...
    <div class="brand_brand_middle">
        <div class="brand_brand_cont">
            <div class="brand_brand_side">
                <ul class="side_bar1">
                    <li class="brand_brandside1">
                    ...
                    <li class="brand_brandside2">
                        <ul>
                            <li class="brand1"><a href="javascript:void(0);" class="ka2">브랜드</a> 
                            ...
                            <form class="brand2" method="post" action="${pageContext.request.contextPath}/pjh/jsp/brand_brandF.do">
            ...
            <div class="brand_brand_content clear">
                <ul class="brand_brand_cont1">
                    <c:choose>
            ...
            <div class="number_page">
				...
				<c:when test="${pageData.prevPage > 0}">
					<c:url value="/pjh/jsp/brand_brandB.do" var="prevPageUrl">
			...
			<c:forEach var="i" begin="${pageData.startPage}" end="${pageData.endPage}" varStatus="status">
				<c:url value="/pjh/jsp/brand_brandB.do" var="pageUrl">
			...
			<c:choose>
				<c:when test="${pageData.nextPage > 0}">
					<c:url value="/pjh/jsp/brand_brandB.do" var="nextPageUrl">
...
$(function() {
	$('.dodoA').click(function() {
		...
		var d1 = document.querySelector('.brand_brandside1');
	...
	$('.dodoB').click(function() {
		...
		var d1 = document.querySelector('.brand_brandside2');
	...
	$('.dodoC').click(function() {
		...
		var d1 = document.querySelector('.brand_brandside3');
	...
	$('.dodoD').click(function() {
		...
		var d1 = document.querySelector('.brand_brandside4');
