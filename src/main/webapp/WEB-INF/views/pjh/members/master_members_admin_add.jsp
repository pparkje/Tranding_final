...
<body>
	...
	Admins keyAA = (Admins) session.getAttribute("keyA");
    session.setAttribute("keyA", keyAA);
%>
    <div class="Main_place">
        <!-- 이 안에서 내용 작업하시면 됩니다. -->
        <div class="sujung_suA">
        	<div class="sujung_userA">
        		<div class="sujung_topA">관리자 추가</div>
        		<form action="${pageContext.request.contextPath}/pjh/members/master_admin_add_ok.do" method="post">
        		<div class="sujung_nameA">
	        		<div>이름</div>
	        		<div class="sujung_name_AA">
	        			<input type="text" name="a_name" placeholder="이름을 입력하세요."  />
	        		</div>
	        	</div>
	        	<div class="sujung_idA">
	        		<div>아이디</div>
	        		<div class="sujung_id_AA">
	        			<input type="text" name="a_id" placeholder="아이디를 입력하세요."  />
	        		</div>
	        	</div>
	        	<div class="sujung_nickA">
	        		<div>비밀번호</div>
	        		<div class="sujung_nick_AA">
	        			<input type="password" name="a_pw" placeholder="비밀번호를 입력하세요."  />
	        		</div>
	        	</div>
	        	<div class="sujung_phoneA">
	        		<div>이메일</div>
	        		<div class="sujung_phone_AA">
	        			<input type="text" name="a_email" placeholder="이메일을 입력하세요." />
	        		</div>
	        	</div>
