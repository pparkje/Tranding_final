package study.test.tranding.dao;
...
import study.tranding.model.Department;
import study.tranding.model.ProfessorDepartment;
...
public class DepartmentTest {
	 ...
	 * ProfessorDepartment input = new ProfessorDepartment(); input.setDname("공학");
